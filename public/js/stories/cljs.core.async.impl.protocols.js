...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26772 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26772(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26773 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26773(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26780 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26780(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26782 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26782(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26783 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26783(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26784 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26784(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26785 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26785(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26787 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26787(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26788 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26788(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26793 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26793(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26797 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26797(b);
}
});
